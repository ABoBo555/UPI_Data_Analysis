...
excel_filename = 'gpay.xlsx'
csv_filename = 'gpay.csv'
                         ...
                         if (status_lower in ['paid', 'sent'] and prefix_lower == 'to ') or \
                            (status_lower == 'received' and prefix_lower == 'from '):
                             recipient_info = potential_recipient
                              ...
                              print(f"Warning [Block {block_index}]: Recipent prefix '{prefix_lower.strip()}' mismatch with status '{status_lower}' in '{remainder}'. Recipent not assigned.")
